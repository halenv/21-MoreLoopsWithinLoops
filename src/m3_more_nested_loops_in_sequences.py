...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 42
    answer = largest_number([[12, 2, 4, 0], [0,], [42]])
    print('Expected and actual are:', expected, answer)
...
def largest_number(seq_seq):
    ...
    largest_num = -999999999999999999
    ...
    for k in range(len(seq_seq)):
        s = seq_seq[k]
        total_length = total_length + len(s)
...
def run_test_largest_negative_number():
    ...
    expected = -1
    answer = largest_negative_number(([10, 0, 1], [-1]))
    print('Expected and actual are:', expected, answer)

    expected = -1111111111111111
    answer = largest_negative_number(([-500, -90], [-9, 9, -27456], [-1111111111111111], [-999999, -15, 0]))
    print('Expected and actual are:', expected, answer)
